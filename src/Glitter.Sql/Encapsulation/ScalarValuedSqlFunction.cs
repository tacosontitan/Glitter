...
/// </summary>
public abstract class ScalarValuedSqlFunction :
    SqlFunction
{
    /// <summary>
    ...
    public ScalarValuedSqlFunction(string functionName) :
        base(functionName)
    { }
    ...
    public ScalarValuedSqlFunction(string schema, string functionName) :
